...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.main_label.setText(_translate("MainWindow", "SMultiVMS"))
        self.full_name_label.setText(_translate(
            "MainWindow", "Smart Multi-Channel Vibration Monitoring System"))
        #self.blue_label.setText(_translate("MainWindow", "Connect bluetooth"))
        self.blue_btn.setText(_translate("MainWindow", "Search bluetooth devices"))
